...
manipulation = ["final", "origin"]                                                                                       ## add new manipulation
...
def blur(blurred_list):
    ...
    brightness(blurredImage)

    return blurred_list


def brightness(blurredImage):

    ## every product receives a brigthness of 0.5 to 1.5

    brightImage = blurredImage.copy()
    ...
    colorSpace(brightImage)

    return brightness_list


def colorSpace(brightImage):

    ## 80% of productes have color space transformation

    colorSpaceImage = brightImage.copy()
    if random.randint(1,100) > 20: 
    ...
    for video_frame in sortedBGPath:
        ...
        for imagePath in os.listdir(inPath):
            ...
            for p in range(random.randint(4,8)):                                                                            
                ...
                if img_manipulation:   
                    blur(blurred_list)                                                                                                 ## add new function
