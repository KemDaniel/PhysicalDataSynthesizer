...
manipulation = ["origin", "origin_without_bb_changes"]#, "blurred", "noise"]                                                                                       ## add new manipulation
...
def calculate_new_bb(changed_masks, orig_masks, x_coord, y_coord):
    ...
    for x in reversed(changed_masks):
        ...
        if not (x == old_x).all():                                        
            ...
            if pix.shape[0] != 0:
                ...
                orig_height, orig_width = x.shape
    ...
    return height_list, width_list, x_coord, y_coord, orig_height_list, orig_width_list
...
for i in range(int(vid_number)):
    ...
    for video_frame in sortedBGPath:
        ...
        for imagePath in os.listdir(inPath):
            ...
            height_list, width_list, random_x_list, random_y_list, orig_height_list, orig_width_list = calculate_new_bb(changed_masks, orig_masks, random_x_list, random_y_list)
            ...
            if img_manipulation:
                for x in manipulation:
                    ...
                    match x:                                                                                                                ## add case
                        ...
                        case "origin_without_bb_changes":
                            save_image(img_list, imgPath, orig_x_list, orig_y_list)
